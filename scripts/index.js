...
const surfaceButton = document.querySelector(".surface__button");
...
function enableDarkMode() {
  ...
  surfaceButton.classList.add("surface__button_theme_dark");
...
function disableDarkMode() {
  ...
  surfaceButton.classList.remove("surface__button_theme_dark");
